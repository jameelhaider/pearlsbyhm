@extends('layouts.app')
@section('title', 'Terms & Conditions - Pearls By HM')
...
@section('content')
    <div class="container">
        ...
        <p style="font-family: Arial, sans-serif; line-height: 1.7;"> Welcome to <strong>Pearls By HM</strong>. By accessing
            ...
            methods provided on our website. Pearls By HM reserves the right to cancel or refuse any order at our
